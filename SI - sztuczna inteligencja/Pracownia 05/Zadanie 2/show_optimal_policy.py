...
for x in open('policies/' + policy_file):
    L = x.split()
...
if should_be[task_file] < expected_utility:
    ...
    print('RESULT', task_file,
          '[WARNING] EXPECTED UTILITY SHOULD BE GREATER THAN', should_be[task_file])
input()
